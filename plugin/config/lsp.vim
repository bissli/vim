if PlugLoaded('vim-lsp')
  ...
  " disable auto-registration of these servers (we register custom ~ versions manually)
  let g:lsp_settings = {
  \   'jedi-language-server': {'disabled': v:true},
  \   'ruff-lsp': {'disabled': v:true},
  \   'sqls': {'disabled': v:true},
  \ }
